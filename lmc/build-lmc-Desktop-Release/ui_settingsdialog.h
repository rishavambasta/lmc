...
public:
    ...
    void setupUi(QDialog *SettingsDialog)
    {
        ...
        chkClearOnClose->setObjectName(QString::fromUtf8("chkClearOnClose"));
    ...
    void retranslateUi(QDialog *SettingsDialog)
    {
        ...
        chkClearOnClose->setText(QApplication::translate("SettingsDialog", "Clear messages when window is closed", 0, QApplication::UnicodeUTF8));
